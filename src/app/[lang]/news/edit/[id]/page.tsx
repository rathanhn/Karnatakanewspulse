...
export default function EditNewsPage({ params }: { params: { id: string, lang: string } }) {
            ...
            try {
                ...
                if (fetchedPost) {
                    if(user && fetchedPost.userId !== user.uid) {
                        ...
                        router.push(`/${unwrappedParams.lang}/home/my-posts`);
                        return;
                    }
                    setPost(fetchedPost);
    ...
    }, [id, user, router, toast, unwrappedParams.lang]);
    ...
    if (error) {
         return (
             <div className="flex flex-col justify-center items-center min-h-screen text-center">
                ...
                <Button asChild>
                    <Link href={`/${unwrappedParams.lang}/home/my-posts`}>Go Back</Link>
                </Button>
            </div>
        )
    }
            ...
            <header className="sticky top-0 z-40 w-full border-b border-border/40 bg-background/95 backdrop-blur-sm">
                <div className="container mx-auto flex h-20 items-center justify-between px-4">
                    ...
                    <Button asChild variant="ghost">
                        <Link href={`/${unwrappedParams.lang}/home/my-posts`}>
